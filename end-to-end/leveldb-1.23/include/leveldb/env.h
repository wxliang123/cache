...
class LEVELDB_EXPORT Env {
 public:
  ...
  virtual Status NewRandomAccessFileWithDirectIO(const std::string& fname,
                                                 RandomAccessFile** result) = 0;
  ...
  virtual Status NewWritableFileWithDirectIO(const std::string& fname,
                                             WritableFile** result) = 0;
...
class LEVELDB_EXPORT EnvWrapper : public Env {
 public:
  ...
  Status NewRandomAccessFileWithDirectIO(const std::string& f,
                                         RandomAccessFile** r) override {
    return target_->NewRandomAccessFileWithDirectIO(f, r);
  }
  Status NewWritableFile(const std::string& f, WritableFile** r) override {
    return target_->NewWritableFile(f, r);
  }
  Status NewWritableFileWithDirectIO(const std::string& f,
                                     WritableFile** r) override {
    return target_->NewWritableFileWithDirectIO(f, r);
  }
